...
Create Date: 2025-08-17 15:40:00.000000
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_id"], ["medication_products.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "ix_product_packages_product_id",
        "product_packages",
        ["product_id"],
        unique=False,
    )
    op.create_index(
        "ix_product_packages_national_number",
        "product_packages",
        ["national_number"],
        unique=False,
    )
    op.create_index(
        "ix_product_packages_gtin", "product_packages", ["gtin"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        "ix_product_packages_national_number", table_name="product_packages"
    )
    op.drop_index(
        "ix_product_packages_product_id", table_name="product_packages"
    )
